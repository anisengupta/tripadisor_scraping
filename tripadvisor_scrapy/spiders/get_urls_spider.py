...
class TripAdvisorURLSpider(scrapy.Spider):
    ...
    custom_settings = {
        "ITEM_PIPELINES": {"tripadvisor_scrapy.pipelines.ExtractURLToCSV": 300},
        "FEEDS": {url_save_path: {"format": "csv", "overwrite": False}},
    }
    ...
    def parse(self, response):
        for item in response.css("div.RfBGI"):
            yield {"url": item.css("a.Lwqic.Cj.b::attr(href)").get()}
